...
abstract class $GroupCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String invitationCode});
}
...
class _$_Group implements _Group {
  const _$_Group({required this.id, required this.invitationCode});
  ...
  @override
  String toString() {
    return 'Group(id: $id, invitationCode: $invitationCode)';
  }
...
abstract class _Group implements Group {
  const factory _Group(
      ...
      required final String invitationCode}) = _$_Group;
