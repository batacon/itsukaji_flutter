...
abstract class $MemberCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String name, String groupId});
}
...
class _$_Member implements _Member {
  ...
  @override
  String toString() {
    return 'Member(id: $id, name: $name, groupId: $groupId)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, id, name, groupId);
...
abstract class _Member implements Member {
  const factory _Member(
      ...
      required final String groupId}) = _$_Member;
